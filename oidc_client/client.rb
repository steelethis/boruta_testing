...
AUTHORIZATION_SERVER = ENV.fetch("AUTHORIZATION_SERVER_URI", "http://localhost:4000/openid/authorize")
RESOURCE_SERVER = ENV.fetch("RESOURCE_SERVER_URI", "http://localhost:9293/")
REDIRECT_URI = "http://localhost:9293/auth/openid_connect/callback"
CLIENT_ID = ENV.fetch("CLIENT_ID", "918bca19-9b4d-47dd-9825-a99d79b20851")
CLIENT_SECRET = ENV.fetch("CLIENT_SECRET", "0c0f98163ccbf3c4babae9fd256c4ce91ac2ed65c186da0d267aa97d027dc3986fee854f6be000d32ce57b290916d25f96c6a576672445ed9e43f6577727f0f9")
...
class ClientApplication < Roda
  ...
  use OmniAuth::Strategies::OpenIDConnect,
      ...
      client_options: {
        ...
        identifier: "918bca19-9b4d-47dd-9825-a99d79b20851",
        secret: "0c0f98163ccbf3c4babae9fd256c4ce91ac2ed65c186da0d267aa97d027dc3986fee854f6be000d32ce57b290916d25f96c6a576672445ed9e43f6577727f0f9",
